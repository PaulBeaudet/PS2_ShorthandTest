...
#define HOLDSTATE 10//ms /wait this long for a hold cycle
...
//--------- Button pin-out
byte buttons[] = { 4,5,6,7 };// up to 16 possible
...
void buttonUpdate() //updates press and release states
...
byte holdHandlr(byte pressState)//cause I wanna
{
